...
$sql_total = "SELECT count(*) FROM warga";		
...
$sql = "SELECT no_ktp,nama,agama, t_lahir, tgl_lahir, j_kel,gol_darah,w_negara,pendidikan , pekerjaan,s_nikah FROM warga";
...
?>
<div class="top-bar">
	<a href="tambah_penduduk.php" class="button">Tambah data </a>
	    <h1>Daftar Penduduk</h1>
        <div class="breadcrumbs">Menampilkan seluruh daftar warga desa</div>
</div>
...
function tambah_field_cari(elm){
	...
	var nama = $(elm).val();
	if(nama != ""){
	var pilihan_elm = new Array("agama","j_kel","s_nikah","gol_darah");
