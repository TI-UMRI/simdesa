...
/*
 *      daftar_surat.php
 *      Menampilkan data surat yang pernah dikeluarkan 
 */
...
?>
<div class="top-bar">
	<a href="tambah_surat_link.php" class="button">Tambah data </a>
	    <h1>Daftar Surat</h1>
        <div class="breadcrumbs">Menampilkan seluruh daftar surat yang telah diterbitkan</div>
</div>
...
function hal(elm){
	...
	var tabel = "surat";
	var nama_id = "id_surat";
	var url_update = "update.php";
	$("#table").html("mohon tunggu .........");
	$.post(url,{hal:hal,bag:bag_sekarang,sql:sql,url_update:url_update,tabel:tabel,nama_id:nama_id,edit:0},function(data){
		$("#table").html(data);
